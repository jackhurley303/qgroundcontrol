...
// macOS-style dark translucent dock for plan-view plugin panels.
...
Item {
    ...
    property var  _panelItems: QGroundControl.pluginManager.planViewPanelItems
    ...
    width:   _dock.width
    height:  _dock.height
    visible: _panelItems.length > 0 && _anyCollapsed
